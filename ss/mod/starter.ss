#V3.30.xx.yy;_safe;_compile_date:_Jun  2 2023;_Stock_Synthesis_by_Richard_Methot_(NOAA)_using_ADMB_13.1
...
-1 # min yr for sdreport outputs (-1 for styr); #_1962
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1685939879
