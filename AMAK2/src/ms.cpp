 ...
 model_data(argc,argv) , function_minimizer(sz)
{
 ...
 Fratio /= sum(Fratio);
  ...
  #endif
  repl_F.allocate(1,nstk,5,"repl_F");
  ...
  Sp_Biom_NoFishRatio.allocate(1,nstk,styr,endyr,"Sp_Biom_NoFishRatio");
  ...
  catch_future.allocate(1,nstk,1,4,styr_fut,endyr_fut,"catch_future");
  #ifndef NO_AD_INITIALIZE
    catch_future.initialize();
  #endif
  SSB_fut.allocate(1,nstk,1,5,styr_fut,endyr_fut,"SSB_fut");
  #ifndef NO_AD_INITIALIZE
    SSB_fut.initialize();
  #endif
...
void model_parameters::set_runtime(void)
{
  ...
  dvector temp1("{100,100,200,300,2500}");
