...
//---------------------------------NEW
  ...
  // Removed these for ADNUTS issues...
  // init_vector repl_F(1,nstk,5)
  // sdreport_vector repl_yld(1,nstk)
  // sdreport_vector repl_SSB(1,nstk)

  vector repl_F(1,nstk)
  vector repl_yld(1,nstk)
  vector repl_SSB(1,nstk)
  ...
  sdreport_matrix Sp_Biom_NoFishRatio(1,nstk,styr+1,endyr)
...
FUNCTION dvariable SolveF3(const int& iyr, const dvar_vector& N_tmp, const double&  TACin, const int& istk)
  RETURN_ARRAYS_INCREMENT();
  dvariable dd = 10.;
  dvariable cc; 
...
FUNCTION double mn_age(const dvar_vector& pobs,const dvector& age_vector)
  double mobs = value(pobs*age_vector);
  return mobs;

FUNCTION double mn_age(const dvector& pobs,const dvector& age_vector)
...
FUNCTION double Sd_age(const dvector& pobs,const dvector& age_vector)
...
FUNCTION double calc_Francis_weights(const dmatrix oac, const dvar_matrix eac, const ivector sam )
 ...
 /**
   ...
   * Produces the new weight that should be used.
  **/
FUNCTION double calc_Francis_weights(dmatrix oac, dvar_matrix eac, ivector sam,const int mina )
  {
    int nobs;
    int i1=oac.rowmin();
    int i2=oac.rowmax();
