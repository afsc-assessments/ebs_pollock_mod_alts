...
\hypersetup{
  pdftitle={Status of Walleye pollock (Theragra chalcogrammus) in the Eastern Bering Sea for 2021},
  pdflang={en},
  hidelinks,
...
\vspace{1.5cm}
{\Large\textbf\newline{Status of Walleye pollock (\emph{Theragra chalcogrammus}) in the Eastern Bering Sea for 2021}}
\vfill
by\\
