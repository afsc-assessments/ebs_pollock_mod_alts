...
year: "2021"
preamble: |
output: sa4all::techreport_pdf
bibliography: sa4all.bib
lang: en
papersize: a4
---
...
# Executive Summary{-}
## Stock{-}
This assessment reports the status of Walleye pollock (_Theragra chalcogrammus_) off the Eastern Bering Sea coast using data through xxxx.
...
<!--chapter:end:30analytic_approach.Rmd-->
...
<!--chapter:end:80bibliography.Rmd-->

\clearpage
# Tables


<!--chapter:end:90tables.Rmd-->
