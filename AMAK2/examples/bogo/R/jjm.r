...
reposDir    <- "c:/users/jim/documents/dropbox/models/atka
codePath    <- file.path(reposDir,"/Ratka/")
inputPath   <- file.path(reposDir,"/prg/")
outputPath  <- file.path(reposDir,"/prg/arc/")
